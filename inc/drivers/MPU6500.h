...
#define MPU6050_WHOAMI_VAL      0x70
#define MPU9250_WHOAMI_VAL      0x71

namespace codal{

    class MPU6500 : public Accelerometer
    {
        I2C& i2c;
    ...
    public:
        ...
        MPU6500(I2C &_i2c, Pin &_int1, CoordinateSpace &coordinateSpace, uint16_t address = MPU6500_DEFAULT_ADDR,  uint16_t id = DEVICE_ID_ACCELEROMETER);
